        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="mb-12">
            <div className="flex items-center mb-6">
              ...
              <h1 className="ml-4 text-3xl font-bold">JobCore</h1>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-white/90 leading-relaxed mb-8 max-w-md">
              Join millions finding jobs that match their skills, goals, and dreams — all in one powerful platform.</p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="ml-3 text-2xl font-bold gradient-text">JobCore</h1>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 border rounded-xl text-gray-900 dark:text-white bg-white dark:bg-slate-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 dark:focus:ring-cyan-400/20 ${errors.fullName
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-4 border rounded-xl text-gray-900 dark:text-white bg-white dark:bg-slate-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 dark:focus:ring-cyan-400/20 ${errors.email
                      ? 'border-red-300 dark:border-red-600 focus:border-red-500 dark:focus:border-red-400'
                      : 'border-gray-300 dark:border-slate-600 focus:border-cyan-500 dark:focus:border-cyan-400'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-4 border rounded-xl text-gray-900 dark:text-white bg-white dark:bg-slate-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 dark:focus:ring-cyan-400/20 ${errors.password
                      ? 'border-red-300 dark:border-red-600 focus:border-red-500 dark:focus:border-red-400'
                      : 'border-gray-300 dark:border-slate-600 focus:border-cyan-500 dark:focus:border-cyan-400'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-4 border rounded-xl text-gray-900 dark:text-white bg-white dark:bg-slate-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 dark:focus:ring-cyan-400/20 ${errors.confirmPassword
                        ? 'border-red-300 dark:border-red-600 focus:border-red-500 dark:focus:border-red-400'
                        : 'border-gray-300 dark:border-slate-600 focus:border-cyan-500 dark:focus:border-cyan-400'
                      }`}
            ...
            <button
              ...
              className={`w-full flex items-center justify-center px-6 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform ${isFormValid() && !isLoading
